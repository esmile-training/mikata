...
class Controller_Testpage extends Controller_Base_Game
{
	...
	public function action_picthatcard()
	{
		...
		$game['table'] = array('status' => $param['statsu'], 'thatCardArray' => $param['thatCardArray'], 'votesArray' => $param['votesArray'],'player' => $param['player'], 'deck'=>array('themeStock' => $param['themeStock'], 'anserStock' => $param['anserStock']));
