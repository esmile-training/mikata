...
<div id="折りたたみB">
<a href="javascript:dd('折りたたみ指示B')"><img src="img/HP_Triangle_TR12pxc008080.gif" id="折りたたみ指示Bi" style="border-width : 0px;" alt="右三角印">　ランキング</a>
<div style="display:none;margin-left:18pt" id="折りたたみ指示B">1位<br>
２位<br>
３位<br>
</div>
</div>